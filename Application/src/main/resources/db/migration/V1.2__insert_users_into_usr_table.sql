...
VALUES (1, 'Только что кончившая гимназию девица желает выйти замуж за холостого или бездетного'
    ' вдовца с состоянием. Возраста не стесняться',
       ...
       (9,
        ...
        'Ебобо', 'MALE'),
       (10,
        'Так жизнь молодая проходит бесследно. А там и скоро конец. Мои девичьи грезы изменили мне. Стремилась к семейному ' ||
        'очагу, но все рассеялось, как дым. И я одна, я всем чужая. Ищу мужа-друга',
        'Алиса', 'FEMALE'),
       (12, 'Простая баба, но лайки никто нет ставит!',
        'Баба', 'FEMALE'),
       (13,
        'Иностранка, обеспеченная, выше средних лет, желает выйти замуж за людину честную, нравственного и обеспеченного. Физические недостатки не имеют значения.',
        'Джессика', 'FEMALE'),
       (14,
        'Явись ко мне мужем, другом, товарищем, не моложе 40 лет отроду, состоятельный, добрый человек. Осчастливлю, согрею твою жизнь. Вдова, 32 лет, интеллигентная армянка высоконравственная, интересная. Томлюсь душевным одиночеством. Анонимам не отвечу.',
        'Акинья Петровна Арамян', 'FEMALE');
...
INSERT INTO find_sex(user_id, find_sex)
VALUES (1, 'MALE'),
       (2, 'MALE'),
       (3, 'FEMALE'),
       (4, 'FEMALE'),
